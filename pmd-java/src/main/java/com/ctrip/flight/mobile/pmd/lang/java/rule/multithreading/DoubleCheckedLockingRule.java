 ...
 */
public class DoubleCheckedLockingRule extends FlightJavaRule {
                                        ...
                                        if (matchName(pe, returnVariableName)) {
                                            if (se.getChild(1) instanceof ASTAssignmentOperator) {
                                                addViolationWithPrecisePosition(data, node,
                                                        DOUBLE_CHECKED_LOCKING_VIOLATION_MSG);
                                            }
                                        }
                                    }
                                }
    ...
    private static final String DOUBLE_CHECKED_LOCKING_VIOLATION_MSG =
            "java.multithreading.DoubleCheckedLockingRule.violation.msg";
}
