 ...
 */
public class UselessOverridingMethodRule extends FlightJavaRule {
    ...
    public Object visit(ASTMethodDeclaration node, Object data) {
        ...
        addViolationWithPrecisePosition(data, node, USELESS_OVERRIDING_METHOD_VIOLATION_MSG);
    ...
    private static final String USELESS_OVERRIDING_METHOD_VIOLATION_MSG =
            "java.design.UselessOverridingMethodRule.violation.msg";
}
