 ...
 */
public class SimplifyBooleanReturnsRule extends FlightJavaRule {
    ...
    public Object visit(ASTIfStatement node, Object data) {
        ...
        if (!node.hasElse() && isIfJustReturnsBoolean(node) && isJustReturnsBooleanAfter(node)) {
            addViolationWithPrecisePosition(data, node, SIMPLIFIED_BOOLEAN_RETURN_VIOLATION_MSG);
            return super.visit(node, data);
        }
    ...
    private static final String SIMPLIFIED_BOOLEAN_RETURN_VIOLATION_MSG =
            "java.design.SimplifyBooleanReturnsRule.violation.msg";
}
