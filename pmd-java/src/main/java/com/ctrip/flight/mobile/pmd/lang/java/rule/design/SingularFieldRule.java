 ...
 */
public class SingularFieldRule extends FlightLombokAwareRule {
    ...
    public Object visit(ASTFieldDeclaration node, Object data) {
        ...
        for (ASTVariableDeclarator declarator : node.findChildrenOfType(ASTVariableDeclarator.class)) {
            ...
            for (int ix = 0; ix < usages.size(); ix++) {
                ...
                ASTPrimaryExpression primaryExpressionParent =
                        location.getFirstParentOfType(ASTPrimaryExpression.class);
            ...
            if (violation && !usages.isEmpty()) {
                addViolationWithPrecisePosition(data, node, SINGULAR_FIELD_VIOLATION_MSG, declaration.getImage());
            }
        }
        return super.visit(node, data);
    }
    ...
    private static final String SINGULAR_FIELD_VIOLATION_MSG =
            "java.design.SingularFieldRule.violation.msg";
}
